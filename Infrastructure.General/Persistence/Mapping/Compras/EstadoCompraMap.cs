namespace Infrastructure.General.Persistence.Mapping.Compras
{
    ...
    public class EstadoCompraMap : IEntityTypeConfiguration<EstadoCompra>
    {
        ...
        {
            builder.ToTable("EstadoCompra", "Compras", t => t.HasComment("Almacena la información de los estados que puede tener una compra dentro del sistema, como Pendiente, Pagada o Cancelada."));
