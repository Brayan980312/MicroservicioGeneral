namespace Infrastructure.General.Extensions
{
    ...
    public class ApplicationLifetimeEventsHostedService : IHostedService
    {
        ...
        {
            Console.WriteLine("Microservicio general iniciado");
        }
        ...
        {
            Console.WriteLine("Microservicio general se está deteniendo...");
        }
        ...
        {
            Console.WriteLine("Microservicio general detenido");
        }
