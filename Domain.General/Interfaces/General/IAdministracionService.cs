...
{
    using Domain.General.CustomEntities;
    ...
    /// <para>Este servicio permite operaciones de actualización y lectura de la entidad pais y ciudad, utilizando los contratos genéricos <see cref="IUpdateService{TParam, TEntity}"/> y <see cref="IReadWithParamsService{TParam, TEntity}"/>.</para>
    /// </summary>
